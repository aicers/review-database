...
mod tests {
    ...
    fn syslog_for_multihostportscan() {
        ...
        assert_eq!(
            ...
            r#"time="1970-01-01T00:01:01+00:00" event_kind="MultiHostPortScan" category="Reconnaissance" orig_addr="127.0.0.1" orig_country_code=[90, 90] resp_addrs="127.0.0.2,127.0.0.3" resp_country_codes=[[90, 90], [90, 90]] resp_port="80" proto="6" start_time="1970-01-01T00:01:01+00:00" end_time="1970-01-01T00:01:02+00:00" triage_scores="""#
        );
    }
    ...
    fn syslog_for_externalddos() {
        ...
        assert_eq!(
            &external_ddos,
            r#"time="1970-01-01T01:01:01+00:00" event_kind="ExternalDdos" category="Impact" orig_addrs="127.0.0.2,127.0.0.3" orig_country_codes=[[90, 90], [90, 90]] resp_addr="127.0.0.1" resp_country_code=[90, 90] proto="6" start_time="1970-01-01T00:01:01+00:00" end_time="1970-01-01T00:01:02+00:00" triage_scores="""#
        );
    }
    ...
    fn syslog_for_blocklist_dcerpc() {
        ...
        assert_eq!(
            ...
            "time=\"1970-01-01T01:01:01+00:00\" \
             ...
             sensor=\"collector1\" \
             orig_addr=\"127.0.0.1\" \
             orig_country_code=[90, 90] \
             orig_port=\"10000\" \
             resp_addr=\"127.0.0.2\" \
             resp_country_code=[90, 90] \
             resp_port=\"135\" \
             proto=\"6\" \
             start_time=\"1970-01-01T00:00:00+00:00\" \
             duration=\"0\" \
    ...
    fn syslog_for_rdpbruteforce() {
        ...
        assert_eq!(
            &rdp_brute_force,
            r#"time="1970-01-01T00:01:01+00:00" event_kind="RdpBruteForce" category="Discovery" orig_addr="127.0.0.1" orig_country_code=[90, 90] resp_addrs="127.0.0.2,127.0.0.3" resp_country_codes=[[90, 90], [90, 90]] start_time="1970-01-01T00:01:01+00:00" end_time="1970-01-01T00:10:02+00:00" proto="6" triage_scores="""#
        );
    }
    ...
    fn syslog_for_blocklist_rdp() {
        ...
        assert_eq!(
            &blocklist_rdp,
            r#"time="1970-01-01T01:01:01+00:00" event_kind="BlocklistRdp" category="InitialAccess" sensor="collector1" orig_addr="127.0.0.1" orig_country_code=[90, 90] orig_port="10000" resp_addr="127.0.0.2" resp_country_code=[90, 90] resp_port="3389" proto="6" start_time="1970-01-01T00:00:00+00:00" duration="0" orig_pkts="0" resp_pkts="0" orig_l2_bytes="0" resp_l2_bytes="0" cookie="cookie" triage_scores="""#
        );
    }
