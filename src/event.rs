...
pub(crate) use self::{
    bootp::{BlocklistBootpFieldsStored, BlocklistBootpFieldsStoredV0_42},
    conn::{
        BlocklistConnFieldsStored, BlocklistConnFieldsStoredV0_42, ExternalDdosFieldsStored,
        ExternalDdosFieldsStoredV0_42, MultiHostPortScanFieldsStored,
        MultiHostPortScanFieldsStoredV0_42, PortScanFieldsStored, PortScanFieldsStoredV0_42,
    },
    ...
    dns::{
        BlocklistDnsFieldsStored, BlocklistDnsFieldsStoredV0_42,
        CryptocurrencyMiningPoolFieldsStored, CryptocurrencyMiningPoolFieldsStoredV0_42,
        DnsEventFieldsStored, DnsEventFieldsStoredV0_42,
    },
    ftp::{
    ...
    http::{
        BlocklistHttpFieldsStored, DgaFieldsStored, DgaFieldsStoredV0_42, HttpEventFieldsStored,
        HttpEventFieldsStoredV0_42, HttpThreatFieldsStored, HttpThreatFieldsStoredV0_42,
        RepeatedHttpSessionsFieldsStored, RepeatedHttpSessionsFieldsStoredV0_42,
    },
    kerberos::{BlocklistKerberosFieldsStored, BlocklistKerberosFieldsStoredV0_42},
    ldap::{
        LdapBruteForceFieldsStored, LdapBruteForceFieldsStoredV0_42, LdapEventFieldsStored,
        LdapEventFieldsStoredV0_42,
    },
    log::ExtraThreatFieldsStored,
    malformed_dns::{BlocklistMalformedDnsFieldsStored, BlocklistMalformedDnsFieldsStoredV0_45},
    mqtt::{BlocklistMqttFieldsStored, BlocklistMqttFieldsStoredV0_42},
    network::{NetworkThreatFieldsStored, NetworkThreatFieldsStoredV0_45},
    nfs::{BlocklistNfsFieldsStored, BlocklistNfsFieldsStoredV0_42},
    ntlm::{BlocklistNtlmFieldsStored, BlocklistNtlmFieldsStoredV0_42},
    radius::{BlocklistRadiusFieldsStored, BlocklistRadiusFieldsStoredV0_45},
    rdp::{
        BlocklistRdpFieldsStored, BlocklistRdpFieldsStoredV0_42, RdpBruteForceFieldsStored,
        RdpBruteForceFieldsStoredV0_42,
    },
    smb::{BlocklistSmbFieldsStored, BlocklistSmbFieldsStoredV0_42},
    smtp::{BlocklistSmtpFieldsStored, BlocklistSmtpFieldsStoredV0_42},
    ssh::{BlocklistSshFieldsStored, BlocklistSshFieldsStoredV0_42},
    sysmon::WindowsThreatFieldsStored,
    tls::{BlocklistTlsFieldsStored, BlocklistTlsFieldsStoredV0_42},
...
mod tests {
    ...
    fn event_db_put_external() {
        ...
        assert_eq!(
            dns_event.orig_country_code,
            crate::util::UNRESOLVED_COUNTRY_CODE
        );
        assert_eq!(
            dns_event.resp_country_code,
            crate::util::UNRESOLVED_COUNTRY_CODE
        );
